...
public class Directions extends Topics
{
...
protected void onCreate(Bundle savedInstanceState) {
	...
	// AudioManager audio settings for adjusting the volume
			...
			gobackBtn.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					Intent intent = new Intent();
					 intent.setClass(Directions.this,Topics.class);
			...
			soundID = soundPool.load(this, R.raw.bus, 1);
			soundID2 = soundPool.load(this, R.raw.police, 1);
			soundID3 = soundPool.load(this, R.raw.train, 1);
			soundID4 = soundPool.load(this, R.raw.rest, 1);
			soundID5 = soundPool.load(this, R.raw.hos, 1);
