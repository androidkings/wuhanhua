...
public class Numbers extends Topics{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// AudioManager audio settings for adjusting the volume
				...
				gobackBtn.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						Intent intent = new Intent();
						 intent.setClass(Numbers.this,Topics.class);
				...
				soundID = soundPool.load(this, R.raw.much, 1);
				soundID2 = soundPool.load(this, R.raw.n05, 1);
				soundID3 = soundPool.load(this, R.raw.n610, 1);
				soundID4 = soundPool.load(this, R.raw.n1115, 1);
				soundID5 = soundPool.load(this, R.raw.n1620, 1);
